...
var getBufferFromString = function getBufferFromString(string) {
  ...
  _createClass(Bulb, [{
    ...
    value: function send(msg) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var message = _this.encrypt(getBufferFromString(JSON.stringify(msg)));
    ...
    key: 'set',
    value: function set() {
      var power = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      ...
      return this.send(msg).then(function (r) {
    ...
    value: function scan(filter) {
      ...
      client.bind(9998, undefined, function () {
        ...
        var msgBuf = Bulb.encrypt(getBufferFromString('{"system":{"get_sysinfo":{}}}'));
        client.send(msgBuf, 0, msgBuf.length, 9999, '255.255.255.255');
      });
      client.on('message', function (msg, rinfo) {
        var decryptedMsg = _this2.decrypt(msg).toString('ascii');
        ...
        var light = new Bulb(rinfo.address);
        light._info = rinfo;
